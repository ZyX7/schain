...
This mechanism has been integrated into Bitcore-Node-Schain which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/schain/insight-api-schain#web-socket-api](https://github.com/schain/insight-api-schain#web-socket-api)
* API: [https://github.com/schain/insight-api-schain#swifttx-transactions](https://github.com/schain/insight-api-schain#swifttx-transactions)
...
By default, the Schain Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Schain Core daemon:
