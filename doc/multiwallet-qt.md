...
In order to support loading of multiple wallets in schain-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is schain.cpp.
...
Changes to schain.cpp
----------------------
schain.cpp is the entry point into schain-qt, and as such, will require some minor modifications to provide hooks for
