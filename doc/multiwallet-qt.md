...
In order to support loading of multiple wallets in save-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is save.cpp.
...
Changes to save.cpp
----------------------
save.cpp is the entry point into save-qt, and as such, will require some minor modifications to provide hooks for
