...
//
// The Masternode Class. It contains the input of the SV collateral, signature to prove
...
public:
    ...
    int64_t nLastDsee;  // temporary, do not schain. Remove after migration to v12
    int64_t nLastDseep; // temporary, do not schain. Remove after migration to v12
