...
/** Utility functions used by the Schain Qt UI.
 */
namespace GUIUtil
{
...
// Render SCH addresses in monospace font
...
// Parse "schain:" URI into recipient object, return true on successful parsing
