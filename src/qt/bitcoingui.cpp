                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Schain Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SCH address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and schain: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Schain Core"), this);
    aboutAction->setStatusTip(tr("Show information about Schain Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Schain"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SCH addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SCH addresses"));
    ...
    openAction->setStatusTip(tr("Open a schain: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Schain Core help message to get a list with possible Schain command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Schain Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Schain network", "", count));
}
...
{
    QString strTitle = tr("Schain Core"); // default title
