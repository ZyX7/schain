                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Save Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SV address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and save: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Save Core"), this);
    aboutAction->setStatusTip(tr("Show information about Save Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Save"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SV addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SV addresses"));
    ...
    openAction->setStatusTip(tr("Open a save: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Save Core help message to get a list with possible Save command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Save Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Save network", "", count));
}
...
{
    QString strTitle = tr("Save Core"); // default title
