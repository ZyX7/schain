...
RESOURCES += src/qt/schain.qrc src/qt/schain_locale.qrc

TRANSLATIONS += src/qt/locale/schain_bg.ts \
                src/qt/locale/schain_de.ts \
                src/qt/locale/schain_en.ts \
                src/qt/locale/schain_es.ts \
                src/qt/locale/schain_fi.ts \
                src/qt/locale/schain_fr.ts \
                src/qt/locale/schain_it.ts \
                src/qt/locale/schain_ja.ts \
                src/qt/locale/schain_pl.ts \
                src/qt/locale/schain_pt.ts \
                src/qt/locale/schain_ru.ts \
                src/qt/locale/schain_sk.ts \
                src/qt/locale/schain_sv.ts \
                src/qt/locale/schain_vi.ts \
                src/qt/locale/schain_zh_CN.ts \
                src/qt/locale/schain_zh_TW.ts
