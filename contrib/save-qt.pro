...
RESOURCES += src/qt/save.qrc src/qt/save_locale.qrc

TRANSLATIONS += src/qt/locale/save_bg.ts \
                src/qt/locale/save_de.ts \
                src/qt/locale/save_en.ts \
                src/qt/locale/save_es.ts \
                src/qt/locale/save_fi.ts \
                src/qt/locale/save_fr.ts \
                src/qt/locale/save_it.ts \
                src/qt/locale/save_ja.ts \
                src/qt/locale/save_pl.ts \
                src/qt/locale/save_pt.ts \
                src/qt/locale/save_ru.ts \
                src/qt/locale/save_sk.ts \
                src/qt/locale/save_sv.ts \
                src/qt/locale/save_vi.ts \
                src/qt/locale/save_zh_CN.ts \
                src/qt/locale/save_zh_TW.ts
