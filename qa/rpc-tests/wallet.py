...
#   c) node1 mines 32 blocks, so now node 0 has 500000SV, node 1 has 4250SV, node2 has none.
#   d) node0 sends 601 SV to node2, in two transactions (301 SV, then 300 SV).
