...
#   c) node1 mines 32 blocks, so now node 0 has 500000SCH, node 1 has 4250SCH, node2 has none.
#   d) node0 sends 601 SCH to node2, in two transactions (301 SCH, then 300 SCH).
